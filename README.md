...
- [Experimental Multi-vendor Getting Started](docs/development/multi-vendor-getting-started.md): Clone the fork, build and run on Radeon/NVIDIA, prepare the native Intel Level Zero path, and [export selected target distributions](docs/development/multi-vendor-distributions.md).
